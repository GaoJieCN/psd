...
try:
    ...
    rel2id = json.load(open('./kd_atlop_v2_2/dataset/docred/rel2id.json', 'r'))
...
def official_evaluate(tmp, path, eval_file):
    '''
    ...
    truth = json.load(open(os.path.join(path, eval_file)))
