...
try:
    docred_rel2id = json.load(open('./dataset/redocred/rel2id.json', 'r'))
except:
    docred_rel2id = json.load(open('./kd_atlop_v2_2_redocred_bert/dataset/redocred/rel2id.json', 'r'))
...
def read_docred(file_in, tokenizer, debug, max_seq_length=1024):
    i_line = 0
    pos_samples = 0
    neg_samples = 0
    features = []
    ...
    for sample in data:
        ...
        features.append((feature, i_line))
        i_line += 1
