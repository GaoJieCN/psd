...
try:
    rel2id = json.load(open('./dataset/redocred/rel2id.json', 'r'))
except:
    rel2id = json.load(open('./kd_atlop_v2_2_redocred_bert/dataset/redocred/rel2id.json', 'r'))
...
def official_evaluate_benchmark(tmp, path, train_file, dev_file):
    ...
    return {'re_f1': re_f1,
            're_f1_ignore_train_annotated': re_f1_ignore_train_annotated,
            're_f1_ignore_train': re_f1_ignore_train,
            're_f1_freq': re_f1_freq,
            're_f1_long_tail': re_f1_long_tail,
            're_f1_intra': re_f1_intra,
            're_f1_inter': re_f1_inter}
